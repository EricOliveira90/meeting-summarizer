...
Proceed only when the preview reports 15 AFK slices, slice 01 / issue #44 as
the sole initial frontier, nine waves, and no missing dependencies.
...
- AFK opens a draft PR containing `Closes #33` through `Closes #47`;
