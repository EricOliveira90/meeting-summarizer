...
Proceed only when the preview reports 16 AFK slices, slice 01 / issue #44 as
the sole initial frontier, ten waves, and no missing dependencies.
...
- AFK opens a draft PR containing `Closes #33` through `Closes #48`;
