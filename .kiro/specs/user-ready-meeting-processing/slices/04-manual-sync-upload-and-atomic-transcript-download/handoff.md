...
- Cleanup-failure containment across later downloads and uploads: `packages/client/src/services/syncManager.ts:SyncManager.fetchResults`
...
- Keep temporary cleanup best effort so a cleanup rejection cannot replace the original retry reason or stop the Manual Sync cycle.
